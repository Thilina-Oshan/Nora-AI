...
import "./nav.css"; // Add custom styles if needed
...
const Navbar = () => {
  ...
  const handleNavClick = () => {
    setExpanded(false); // Collapse navbar when link is clicked (on mobile)
  };
  ...
  return (
    <nav className="navbar navbar-expand-lg fixed-top p-3 bg-dark shadow-sm">
      <div className="container">
        {/* Logo */}
        <a className="navbar-brand text-white" href="#home" onClick={handleNavClick}>
